    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          {authLinks.map((link) => (
            <a
              ...
              className="flex items-center text-foreground/80 hover:text-blue-500 dark:hover:text-blue-400 font-medium text-sm animate-smooth nav-item-hover"
            >
              {link.icon && link.icon}
              {link.name}
            </a>
          ...
          <button
            ...
            className="ml-4 p-2 rounded-full bg-secondary hover:bg-blue-100 dark:hover:bg-blue-900/30 animate-button hover-lift"
        ...
        <div className="md:hidden flex items-center">
          <button
            onClick={toggleDarkMode}
            className="mr-2 p-2 rounded-full bg-secondary hover:bg-blue-100 dark:hover:bg-blue-900/30 animate-button"
            aria-label="Toggle dark mode"
          >
            {isDarkMode ? <Sun size={18} /> : <Moon size={18} />}
          </button>
          ...
          <button
            ...
            className="p-2 rounded-full bg-secondary hover:bg-blue-100 dark:hover:bg-blue-900/30 animate-button"
      ...
      <div 
        className={cn(
          "fixed inset-0 bg-background/95 backdrop-blur-sm z-40 animate-smooth flex flex-col pt-24 px-8",
        ...
        <nav className="flex flex-col space-y-6">
          ...
          {authLinks.map((link) => (
            <a
              ...
              className="flex items-center text-foreground text-lg font-medium animate-smooth hover:text-blue-500 dark:hover:text-blue-400"
            >
              {link.icon && link.icon}
              {link.name}
            </a>
